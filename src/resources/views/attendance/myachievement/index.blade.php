...
@section('css')
<link rel="stylesheet" href="{{ asset('css/attendance/myachievement/index.css') }}">
<style>
  svg.w-5.h-5 {
...
<section class="attendance">
    <div class="attendance__outer">
        <h2 class="attendance__title">
            <div class="attendance__title-navi-day" >{{ $user_name }}さん</div>
        </h2>
            ...
            <table class="attendance__indextable">
                <tbody class="attendance__indextable-body">
                    ...
                    <tr class="attendance__indextable-row">
                        <td class="attendance__indextable-data--name">{{ $att_record->work_on }}</td>
